            ...
            <div class="l-inner">
              ...
              <div class="vision__discription">
                <p class="vision__discription-text">
                  2004年に施行された「性同一性障害者の性別の取扱いの特例に関する法律」以降、性別違和（性同一性障害）については「障がい」という文脈で一定の理解が進みました。また、2015年より自治体で同性パートナーシップ条例が導入されましたが、依然として性的マイノリティについては、いまだに正確な情報・知識が行きわたらず、家庭・学校・職場・地域で、依然として多くの誤解や偏見にさらされています。<br>
                  <br>
                ...
                <dl class="item__inner">
                  ...
                  <div class="item__list">
                    <dt class="item__list-title">メール</dt>
					          <dd>kyouseinet2020[a*t]gmail.com [a*t]を@に書き換えてください</dd>
                  </div>
                </dl>
              </div>
            </div>
